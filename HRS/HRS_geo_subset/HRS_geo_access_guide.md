...
Once the data is downloaded and extracted, run the `HRS_geo_dataset_construction.Rmd` script in `/HRS/HRS_geo_subset/`. This will generate the supplementary geographic dataset.
