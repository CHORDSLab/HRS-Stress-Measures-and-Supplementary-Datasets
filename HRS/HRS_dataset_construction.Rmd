...
⚠️ Before continuing, make sure you’ve downloaded and organized the required raw data. See [`HRS_access_guide.md`](HRS_access_guide.md) for instructions.

<img src="images/hrs_data_prep/step01_data_prep.png" alt="HRS Data Prep" width="80%"/> 
...
<img src="images/step04_hrs_final.png" alt="Final Folder Structure" width="80%"/> 
...
💡 Reminder: Access to biomarker files requires registration and approval from HRS. Passphrases for restricted datasets are provided by HRS via email upon approval.
