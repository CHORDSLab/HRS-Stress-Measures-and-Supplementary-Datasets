...
⚠️ As noted in the [`NHANES_data_guide.md`](../data_access/NHANES_data_guide.md), this script uses the `nhanesA` package to programmatically access NHANES data, rather than relying on manual downloads.
